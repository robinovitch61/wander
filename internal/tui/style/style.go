...
var (
	...
	Filter                     = Regular.Copy().Margin(0, 1)
	FilterPrefix               = Regular.Copy().Padding(0, 3).Border(lipgloss.NormalBorder(), true)
	FilterEditing              = Regular.Copy().Padding(0, 1).Margin(0, 1).Foreground(black).Background(blue)
	FilterApplied              = Regular.Copy().Padding(0, 1).Margin(0, 1).Foreground(black).Background(greenblue)
