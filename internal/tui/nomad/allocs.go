...
/*func FetchAllocs(client api.Client, columns []string) tea.Cmd {*/
	/*return func() tea.Msg {*/
		/*jobListOpts := &api.JobListOptions{*/
			/*Fields: &api.JobListFields{Meta: true},*/
		/*}*/
		/*jobResults, _, err := client.Allocations().ListOptions(jobListOpts, nil)*/
		/*if err != nil {*/
		...
		/*return PageLoadedMsg{Page: AllocsPage, TableHeader: tableHeader, AllPageRows: allPageData}*/
	/*}*/
/*}*/
...
/*func allocResponsesAsTable(jobResponse []*api.JobListStub, columns []string) ([]string, []page.Row) {*/
...
/*func AllocIDAndNamespaceFromKey(key string) (string, string) {*/
